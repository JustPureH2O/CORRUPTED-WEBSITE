...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://justpureh2o.cn",

	// 站点描述
	description:
		"这是 JustPureH2O 的个人博客，主打高中文化课知识整理、信息竞赛算法、信息竞赛题解以及一些学校生活中的趣事逸闻",
	...
	pages: {
		...
		// 留言板页面开关，需要配置评论系统
		guestbook: true,
		// 番组计划页面开关，含追番、游戏、书籍和音乐，dev调试时只获取一页数据，build才会获取全部数据（不用）
		bangumi: false,
	},
